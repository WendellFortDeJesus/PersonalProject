  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_cell: "text-muted-foreground rounded-md w-full font-black text-[0.7rem] uppercase text-center flex items-center justify-center h-8",
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 w-full flex items-center justify-center"
        ),
