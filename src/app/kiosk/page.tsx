          ...
          <CardContent className="px-8 pb-10 space-y-8">
            ...
            <div className="space-y-6 pt-4 border-t border-white/5">
              ...
              <Button 
                ...
                variant="outline"
                className="w-full h-14 border-white/5 bg-white/5 rounded-2xl text-[10px] font-black text-white uppercase tracking-[0.15em] flex items-center justify-center gap-4 hover:bg-white/10 transition-all group shadow-xl"
              >
