          ...
          <CardContent className="px-8 pb-10 space-y-8">
            <div className="relative bg-black/40 p-1.5 rounded-2xl h-14 border border-white/10 flex items-center shadow-inner">
              ...
              <button 
                ...
                className={cn(
                  "relative z-10 flex-1 flex items-center justify-center gap-2 text-[9px] font-black uppercase tracking-widest transition-colors duration-300",
                  activeTab === 'google' ? "text-white" : "text-slate-500 hover:text-slate-400"
                )}
              >
            ...
            <div className="min-h-[300px]">
              {activeTab === 'rfid' ? (
                ...
                <div className="space-y-10 animate-fade-in pt-12 flex flex-col items-center justify-center">
                  <div className="text-center space-y-4">
                    ...
                    <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest leading-relaxed max-w-[240px] mx-auto">
                      Use your @{enforcedDomain} account for instant registry verification.
                    </p>
                  </div>
                  ...
                  <Button 
                    ...
                    className="w-full max-w-xs h-16 bg-white text-black hover:bg-white/90 rounded-2xl text-[11px] font-black uppercase tracking-widest flex items-center justify-center gap-4 transition-all active:scale-[0.98] shadow-2xl"
                  >
