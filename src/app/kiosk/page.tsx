    ...
    try {
      ...
      if (error.code === 'auth/unauthorized-domain') {
        toast({
          ...
          description: "DOMAIN NOT AUTHORIZED. PLEASE ADD THE WORKSTATION URL TO FIREBASE SETTINGS.",
        });
      } else {
        toast({
          variant: "destructive",
              ...
              {activeTab === 'rfid' ? (
                ...
                <div className="space-y-8 animate-fade-in pt-4">
                  ...
                  <div className="relative flex items-center gap-4 py-2">
                    ...
                    <span className="text-[8px] font-black uppercase tracking-widest text-slate-600">Institutional SSO Gateway</span>
                    <div className="h-px bg-white/5 flex-1" />
                  </div>
                  ...
                  <Button 
                    ...
                    variant="outline"
                    className="w-full h-16 border-white/10 bg-white/5 rounded-2xl text-[10px] font-black text-white uppercase tracking-widest flex items-center justify-center gap-4 hover:bg-white/10 transition-all group shadow-xl"
                  >
                    ...
                    {isLoading ? "INITIALIZING SSO..." : "SIGN IN WITH GOOGLE (@NEU.EDU.PH)"}
                  </Button>
                </div>
              )}
            </div>
