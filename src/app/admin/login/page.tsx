    ...
    try {
      ...
      if (userEmail.toLowerCase() === 'jcesperanza@neu.edu.ph') {
        ...
        toast({
          variant: "destructive",
          title: "ACCESS DENIED",
          description: "UNAUTHORIZED IDENTITY DETECTED FOR STAFF ACCESS.",
        });
        setIsLoading(false);
      }
    } catch (error: any) {
      ...
      if (error.code === 'auth/popup-blocked') {
        toast({
          variant: "destructive",
          title: "POPUP BLOCKED",
          description: "PLEASE ENABLE POPUPS TO COMPLETE AUTHORIZATION.",
        });
        ...
        toast({
          ...
          description: error.message || "FAILED TO INITIALIZE SSO.",
        });
      }
    }
  };
          ...
          <CardContent className="px-8 pb-8 space-y-6">
            <div className="space-y-4">
              <Button 
                ...
                disabled={isLoading}
                className="w-full h-16 bg-white text-primary hover:bg-slate-50 font-black text-[11px] uppercase tracking-[0.2em] rounded-2xl shadow-xl shadow-primary/20 flex items-center justify-center gap-4 transition-all"
              >
                {isLoading ? (
              ...
              <div className="relative flex items-center gap-4 py-2">
                ...
                <span className="text-[8px] font-black uppercase tracking-[0.3em] text-slate-500">OR PROVIDE TOKEN</span>
                <div className="h-px bg-white/10 flex-1" />
              </div>
