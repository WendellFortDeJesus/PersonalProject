...
export const DEPARTMENTS = [
  ...
  'College of Education: Bachelor of Elementary Education (Early Childhood, Special Education), Bachelor of Secondary Education (English, Filipino, Math, Social Studies, Science, MAPEH)',
  ...
  'College of Music: Bachelor of Music (Music Education, Voice, etc.)',
